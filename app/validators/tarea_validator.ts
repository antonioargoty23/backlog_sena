...
export const tareaValidator = vine.compile(
  vine.object({
    ...
    tipo: vine.enum(['frontend', 'backend', 'base_datos', 'pruebas', 'documentacion'] as const),
...
export const tareaMessages = {
  ...
  'tipo.enum': 'El tipo debe ser: frontend, backend, base_datos, pruebas o documentacion',
